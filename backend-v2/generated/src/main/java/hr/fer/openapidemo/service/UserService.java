...
import hr.fer.openapidemo.entity.Role;
...
public class UserService {
	...
	public void changePassword(Long id, ChangePasswordRequest request, String currentUserEmail) {
        System.out.println("changePassword called for id: " + id + " by: " + currentUserEmail);
        User user = userRepository.findById(id)
            .orElseThrow(() -> new RuntimeException("Korisnik s ID-om " + id + " nije pronađen"));
        ...
        if (!user.getEmail().equals(currentUserEmail) && 
            userRepository.findByEmail(currentUserEmail)
                ...
                .orElse(true)) {
            throw new RuntimeException("Nemate pravo mijenjati tuđu lozinku");
        }
